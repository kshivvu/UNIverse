    ...
    <nav className="z-50 sticky top-0 overflow-hidden backdrop-blur-lg shadow-lg bg-white">
      <div className="flex justify-between items-center py-3 px-4 md:px-12">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          <button className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-md font-semibold text-sm sm:text-base bg-neutral-200 text-blue-500 hover:bg-blue-500 hover:text-white transition hover:scale-105 duration-300">
            Login
          </button>
